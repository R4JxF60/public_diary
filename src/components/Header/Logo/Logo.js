    ...
    render() {
        return (
            <div className="flex items-center justify-center">
                <a href="#" className="text-center lg:w-80 md:w-64 cursor-pointer font-pd-handwrite text-pd-accent-blue lg:text-4xl md:text-3xl hidden md:block dark:text-pd-dark-accent-blue">Public Diary</a>
