...
class PublicNote extends React.Component {
    ...
    render() {
        return(<div className="p-3 bg-pd-fade-blue rounded-xl border border-solid border-pd-stroke-blue mb-2">
            ...
            <div className="mt-1 text-xs text-pd-text-gray">Public Note from <span className="text-pd-accent-blue underline cursor-pointer font-medium">{this.props.from}</span></div>
        </div>);
    }
}
